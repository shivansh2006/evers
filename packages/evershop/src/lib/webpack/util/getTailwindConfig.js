...
module.exports.getTailwindConfig = function getTailwindConfig(route) {
  const defaultTailwindConfig = route.isAdmin
    ? require('@amohajewellery/amohajewellery/src/modules/cms/services/tailwind.admin.config.js')
    : require('@amohajewellery/amohajewellery/src/modules/cms/services/tailwind.frontStore.config.js');
