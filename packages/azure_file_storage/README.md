# Azure storage extension for amohajewellery

This extension allows you to store your amohajewellery files including product images, banners on Azure Blob Storage.
...
```bash
npm install @amohajewellery/azure_file_storage
```
  ...
  "system": {
    ...
    "extensions": [
      ...,
      {
        ...
        "resolve": "node_modules/@amohajewellery/azure_file_storage",
        "enabled": true,
        "priority": 10
      }
    ]
...
```bash
AZURE_STORAGE_CONNECTION_STRING="DefaultEndpointsProtocol=https;AccountName=myamohajewellery;AccountKey=+b1/nrwkpOF5DZCybDqSDFDdfGCQSbx8eua3y7sadgfdgdfAdNNbns6xMNh+EeE0b10uc0ZJ+AStvBx8pg==;EndpointSuffix=core.windows.net"
